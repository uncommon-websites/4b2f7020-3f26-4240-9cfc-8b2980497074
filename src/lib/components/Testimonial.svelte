...
<section class="py-24 bg-white border-t border-gray-200 font-sans">
     <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-16">
            <h2 class="text-4xl md:text-5xl font-serif-display text-gray-900">Growth teams scaling <br/> faster with Lapis</h2>
        </div>
        ...
        <div class="grid md:grid-cols-2 border border-gray-200">
             <div class="p-12 md:p-16 flex flex-col justify-between border-r border-gray-200">
                 <div>
                     ...
                     <p class="text-gray-500 text-lg mb-12">Head of Growth, Reducto</p>
                     <blockquote class="text-2xl md:text-3xl font-serif-display text-gray-700 leading-tight">
                         "Lapis gave us agency-level creative output without the agency price tag. We're shipping campaigns 5x faster now."
                     </blockquote>
                 </div>
                 <div class="mt-16 grid grid-cols-3 gap-8 items-end opacity-40 grayscale">
                     <!-- Logos -->
                     <div class="h-8 flex items-center">
                        <span class="font-bold text-xl tracking-widest">REDUCTO</span>
                     </div>
                     <div class="h-8 flex items-center">
                        <span class="font-bold text-xl">AtoB</span>
                     </div>
                     <div class="h-8 flex items-center">
                        <span class="font-bold text-xl">Backbone</span>
                     </div>
                 </div>
             </div>
